...
public class WhileQ2 {
	...
	public static void main(String[] args) {
		...
		// for문같은경우 위 3개 요소를 한 줄에 담는다면
		// While은 따로 떨어뜨려 두는것이 특징입니다.
		// 따라서 한 줄에 잇나, 떨어져있냐만 빼면 사실상 같은 구문 입니다.
		...
		while(i < 10) {
			...
			// j while문 변수 생성
			int j = 1;// i가x단이므로, j는 1부터 시작합니다.
			while(j < 10) {// j while 문의 조건식 생성 (범위 1~9를 가지게 합니다.)
				System.out.println(i + " * " + j +" = " + i * j);
			    j++;
			}
			System.out.println("=============");
			
			// for문은 다 돌고나서 i값을 증가시키키 때문에 우선 아래쪽에 둡니다.
			i++; // i = i = + 1; // i +=1; 
			// i값을 증가시킵니다.
		}
	}
